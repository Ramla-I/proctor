...
Vendored change: `requests`/`bs4` imports are lazy (moved into
`_fetch_content`) so loading a cached lint map needs neither dependency —
only regenerating it from the clippy website does. See PROVENANCE.md."""
